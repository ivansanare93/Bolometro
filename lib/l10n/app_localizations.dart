...
abstract class AppLocalizations {
  ...
  /// Menu action to unarchive/restore a season
  ///
  /// In es, this message translates to:
  /// **'Restaurar temporada'**
  String get unarchiveSeason;

  /// Badge shown on archived seasons
  ///
  /// In es, this message translates to:
  /// **'Archivada'**
  String get archivedSeasonLabel;

  /// Confirmation dialog body for archiving a season
  ///
  /// In es, this message translates to:
  /// **'¿Archivar la temporada "{name}"? Podrás restaurarla en cualquier momento.'**
  String archiveSeasonConfirm(String name);

  /// Snackbar after successfully archiving a season
  ///
  /// In es, this message translates to:
  /// **'Temporada archivada'**
  String get seasonArchived;

  /// Snackbar after successfully unarchiving a season
  ///
  /// In es, this message translates to:
  /// **'Temporada restaurada'**
  String get seasonUnarchived;

  /// Section header for archived seasons list
  ///
  /// In es, this message translates to:
  /// **'Temporadas archivadas'**
  String get archivedSeasons;

  /// Button/toggle to show archived seasons
  ///
  /// In es, this message translates to:
  /// **'Mostrar archivadas'**
  String get showArchivedSeasons;

  /// Button/toggle to hide archived seasons
  ///
  /// In es, this message translates to:
  /// **'Ocultar archivadas'**
  String get hideArchivedSeasons;

  /// Session count badge for a season (e.g. "3 sesiones")
  ///
  /// In es, this message translates to:
  /// **'{count} sesiones'**
  String sessionCountForSeason(int count);

  /// Tooltip/button label for enabling bulk-select mode
  ///
  /// In es, this message translates to:
  /// **'Seleccionar sesiones'**
  String get selectSessions;

  /// Number of sessions currently selected (e.g. "2 seleccionadas")
  ///
  /// In es, this message translates to:
  /// **'{count} seleccionadas'**
  String selectedSessionsCount(int count);

  /// Action button to assign selected sessions to a season
  ///
  /// In es, this message translates to:
  /// **'Asignar a temporada'**
  String get assignToSeason;

  /// Confirmation dialog body for bulk season assignment
  ///
  /// In es, this message translates to:
  /// **'¿Asignar {count} sesión(es) a "{season}"?'**
  String bulkAssignConfirm(int count, String season);

  /// Snackbar after successful bulk season assignment
  ///
  /// In es, this message translates to:
  /// **'{count} sesiones asignadas'**
  ...
  /// Group-by-season toggle tooltip
  ///
  /// In es, this message translates to:
